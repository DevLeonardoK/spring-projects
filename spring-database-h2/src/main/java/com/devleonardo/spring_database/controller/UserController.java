...
public class UserController {
    ...
    public UserEntity alterar(@PathVariable("id") long id, @RequestBody UserRequest user) {
        ...
        if (user.getNome() != null) userEntity.setNome(user.getNome());

        if (user.getIdade() != null) userEntity.setIdade(user.getIdade());

        if (user.getEmail() != null) userEntity.setEmail(user.getEmail());

        if (user.getAdmin() != null) userEntity.setAdmin(user.getAdmin());
